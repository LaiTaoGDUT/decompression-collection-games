...
| `doodle-jump` | 纸片跳跃（规划中） | [玩法规格](games/doodle-jump/DOODLE_JUMP_GAMEPLAY_SPEC.md)、[图片提示词](games/doodle-jump/DOODLE_JUMP_IMAGE_PROMPTS.md)、[音频提示词](games/doodle-jump/DOODLE_JUMP_AUDIO_PROMPTS.md) |
